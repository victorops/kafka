...
#
# Adapted from kafka-run-class.sh to point the classpath at the fat jar created by "sbt assembly"
#
#
...
for file in $base_dir/core/target/*.jar;
do
...
for file in $base_dir/perf/target/*.jar;
do
  CLASSPATH=$CLASSPATH:$file
done
